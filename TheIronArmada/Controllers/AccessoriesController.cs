...
namespace TheIronArmada.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        {
            var accessories = db.Accessories.Include(a => a.Type);
        ...
        public ActionResult Create([Bind(Include = "AccID,Name,TypeID")] Accessory accessory)
        {
            ...
            ViewBag.TypeID = new SelectList(db.Types, "TypeID", "Name", accessory.TypeID);
            return View(accessory);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccID,Name,TypeID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
